...
const { hasAtLeastOneElement } = require('r-assign/lib/internal/array-checks');
const { invalidShape } = require('r-assign/lib/internal/errors');
const {
	getTypeGuardMeta,
	setTypeGuardMeta
} = require('r-assign/lib/internal/type-guard-meta');
const { isLiteralOf } = require('r-assign/lib/literal');
const { isNever } = require('r-assign/lib/never');
 ...
 */
const isOmitFrom = (type, names) => isPartFrom(type, names, false);
 ...
 */
const isPickFrom = (type, names) => isPartFrom(type, names, true);
