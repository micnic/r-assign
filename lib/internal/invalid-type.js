...
import { getTypeDescription, getTypeGuardMeta } from './type-guard-meta.js';
...
const invalidType = (context, type, value) => {
	...
	return `${context}, expected ${
		getTypeDescription(meta)
	} ${
		receivedType(value, meta.classification)
	}`;
};
 ...
 * @returns {string}
 */
export const invalidDefaultValue = (type, value) =>
 ...
 * @returns {string}
 */
export const invalidFunctionArguments = (type, value) =>
 ...
 * @returns {string}
 */
export const invalidFunctionReturn = (type, value) =>
 ...
 * @returns {string}
 */
export const invalidPromiseResolve = (type, value) =>
 ...
 * @returns {string}
 */
export const invalidRefineValue = (type, value) =>
 ...
 * @returns {string}
 */
export const invalidOptionalType = (context) =>
 ...
 * @returns {string}
 */
export const invalidValue = (type, value, key) =>
