import { hasOneElement } from './array-checks.js';
import { getTypeDescription } from './type-guard-meta.js';
 ...
 * @returns {string}
 */
const invalidType = (context, meta, value) =>
	`${context}, expected ${getTypeDescription(meta)} ${receivedType(
		value,
		meta.classification
	)}`;

/**
 * Message for invalid default value type error
 * @param {TypeGuardMeta} meta
 * @param {any} value
 * @returns {string}
 */
export const invalidDefaultValue = (meta, value) =>
	invalidType('Invalid default value type', meta, value);
 ...
 * @returns {string}
 */
export const invalidFunctionArguments = (meta, value) =>
	invalidType('Invalid function arguments', meta, value);
 ...
 * @returns {string}
 */
export const invalidFunctionReturn = (meta, value) =>
	invalidType('Invalid function return', meta, value);
 ...
 * @returns {string}
 */
export const invalidFunctionVoidReturn = (value) =>
 ...
 * @returns {string}
 */
export const invalidPromiseResolve = (meta, value) =>
	invalidType('Invalid promise resolve', meta, value);
 ...
 * @returns {string}
 */
export const invalidPromiseVoidResolve = (value) =>
 ...
 * @returns {string}
 */
export const invalidRefineValue = (meta, value) =>
	invalidType('Invalid refine value type', meta, value);
 ...
 * @returns {string}
 */
export const invalidValue = (meta, value) =>
	invalidType('Invalid value type', meta, value);