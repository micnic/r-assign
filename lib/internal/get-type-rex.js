 ...
 * @typedef {import('r-assign/lib/internal').STL<T>} StringifiedTemplateLiteral
 */
 ...
 * @returns {string}
 */
const getTemplateLiteralREXString = (template) => {
 ...
 * @returns {RegExp}
 */
const getTemplateLiteralREX = (template) => {
