...
/**
 * @template T
 * @typedef {import('r-assign/lib').ExtractIntersection<T>} ExtractIntersection
 */
 ...
 * @returns {TypeGuard<ExtractIntersection<I>>}
 */
const isIntersectionOf = (intersection) => {
	...
	/** @type {TypeGuard<ExtractIntersection<I>>} */
 ...
 * @template {Intersection<any>} I
 * @param {I} intersection
 * @param {ExtractIntersection<I>} initial
 * @returns {TransformFunction<ExtractIntersection<I>>}
 */
