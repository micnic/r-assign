...
/**
 * @typedef {import('./internal/index.js').ARTGM} ArrayTypeGuardMeta
 */
...
/** @type {['array', 'tuple']} */
const inputClassifications = ['array', 'tuple'];
...
export const isFunction = (input, output) => {
	...
	// Assert input type
	assertClassification(inputMeta.classification, inputClassifications);

	// Assert output type
	assertBaseClassification(outputMeta.classification);
